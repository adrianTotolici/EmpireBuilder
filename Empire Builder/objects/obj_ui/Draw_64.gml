...
if (_show_tools_menu){
	...
	draw_sprite_ext(spr_ui_button_black_background,0,0,y_size_ui/2+38,1.5,1,0,c_white,1);
	draw_sprite_ext(spr_ui_spear_0,0,sprite_size/2,y_size_ui/2+52,0.45,0.45,0,c_white,1);
	draw_text(55,y_size_ui/2+25,"+ 1");
	
	draw_sprite_ext(spr_ui_button_black_background,0,0,y_size_ui/2+76,1.5,1,0,c_white,1);
...
if (ui_build_selected){
	...
	draw_sprite_ext(spr_herbalist_hut_lvl0,0,x_size_ui-(sprite_size*2),414,0.5,0.5,0,c_white,1);
...
if (show_material_inventory){
	...
	draw_sprite_ext(spr_ui_button_black_background,0,_x_pos_start+200,sprite_size+315,2,1,0,c_white,1);
...
if (show_tools_inventory){
	...
	draw_sprite_ext(spr_ui_button_black_background,0,_x_pos_start+332,sprite_size+45,2,1,0,c_white,1);
	...
	draw_sprite_ext(spr_ui_button_black_background,0,_x_pos_start+332,sprite_size+90,2,1,0,c_white,1);
